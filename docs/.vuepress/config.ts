...
const DOMAIN_NAME = "www.zhuyanlin.com"; // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    docsDir: "docs", // 编辑的文件夹
    sidebarDir: "", // 侧边栏文档目录 add by alexi
    ...
    author: {
      name: "alexi", // 必需
      link: "https://github.com/yoloalexi", // 可选的
    },
      ...
      icons: [
        {
          ...
          title: "发邮件",
          link: "mailto:zyl1012373078@163.com",
        },
        {
          iconClass: "icon-github",
          title: "GitHub",
          link: "https://github.com/yoloalexi",
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Alexi | <a href="http://www.beian.gov.cn" target="__blank">京ICP备2024048356号</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ["link", { rel: "icon", type:'image/png', href: "/img/logo.png" }], //favicons，资源放在public文件夹
    ...
    [
      commonPlugin,
      {
        ...
        options: {
          ...
          // owner: 'yoloalexi', // GitHub仓库所有者
          // admin: ['yoloalexi'], // 对仓库有写权限的人
